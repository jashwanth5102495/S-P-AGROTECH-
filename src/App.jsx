  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden">
      ...
      <header className="pt-0 sm:pt-0 mt-6 sm:mt-8 pb-6 text-center select-none">
        <div className="mx-auto w-[340px] sm:w-[440px] h-[160px] sm:h-[200px] rounded-2xl bg-white/70 border border-white/50 backdrop-blur-lg overflow-hidden shadow-[0_20px_40px_rgba(0,0,0,0.25)] transition-transform duration-300 hover:-translate-y-0.5 hover:shadow-[0_30px_60px_rgba(0,0,0,0.3)]">
           <video src="/logo.mp4" className="w-full h-full object-cover rounded-2xl bg-white/70 backdrop-blur-lg shadow-inner" autoPlay muted loop playsInline />
        </div>
